...
//==============================================================
//     <h> Fonts selection: check to include *.C files in this project
//         <q0.0>  font8.c 
//         <q0.1>  font12.c
//         <q0.2>  font16.c 
//         <q0.3>  font20.c 
...
//     <o2.0..3> LCD Display Direction
//          <1=>    Landscape
//          <2=>    Portrait
//--------------------------
#define __Fonts_select         0x0000001F			//0
#define __default_Font         2			//1
#define __LCD_DIRECT	         2      //2 ==> 1: LANDSCAPEそ  2: PORTRAIT

//=================================================

//     <e0> LCD Reset Pin (default PC5)
...
//                 <9=> PORT J 
//                 <10=> PORT K 
//     <o2>  (0~15) Pin number of LCD Reset pin <0-15>
//     </e>
//     <h> LCD Backlight Pin (default PB0)
//     <o3> port label of LCD backlight pin
//                 <0=> PORT A 
//                 <1=> PORT B 
//                 <2=> PORT C 
//                 <3=> PORT D 
...
//                 <9=> PORT J 
//                 <10=> PORT K 
//     <o4>  (0~15)Pin number of LCD Backlight pin <0-15>
//     </h>
//=================================================
...
//     <h> LCD FSMC Pin in Set 4
//						<i> PF0~PF5 ==> FSMC A0~A5
//						<i> PF12~PF15 ==> FSMC A6~A9
//						<i> PG9~PG10, PG12 ==> FSMC NE2~NE3, NE4
//						<i> PG0~PG5 ==> FSMC A10~A15
//						<i> PG13~PG14 ==> FSMC A24~A25
//     <o6>   port label of FSMC Set 4
//                 <0=> PORT A 
//                 <1=> PORT B 
//                 <2=> PORT C 
//                 <3=> PORT D 
...
#define PinBit_FSMC_set1 0xFFB3     		// 1
...
#define PinBit_FSMC_set4	0xF63F        // 7


//=================================================
//     <o0> Default Text Color
//       <0xFFFF=> LCD_COLOR_WHITE
//       <0x001F=> LCD_COLOR_BLUE
//       <0xF800=> LCD_COLOR_RED
//       <0xF81F=> LCD_COLOR_MAGENTA
//     <o1> Default Background Color
//       <0x0000=> LCD_COLOR_BLACK
//       <0xFFE0=> LCD_COLOR_YELLOW
//       <0x07E0=> LCD_COLOR_GREEN
//       <0x8410=> LCD_COLOR_GRAY

#define Default_TextColor		0xFFFF    // Default: White
#define Default_BackColor		0x0000    // Default: Black
