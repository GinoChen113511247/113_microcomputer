...
//   </h>
// </h>
#define PNr_FSMC_set1 0									// 0
#define PinBit_FSMC_set1 0x0006     		// 1
#define PNr_FSMC_set2 0									// 2
#define PinBit_FSMC_set2	0xFF80        // 3
#define PNr_FSMC_set3 0									// 4
#define PinBit_FSMC_set3	0x1000        // 5
#define PNr_FSMC_set4 0									// 6
#define PinBit_FSMC_set4	0xF03F        // 7
//--------------------------------------------------
...
//       <0xFFFF=> LCD_COLOR_BLACK
//       <0x001F=> LCD_COLOR_YELLOW
//       <0xF800=> LCD_COLOR_GREEN
//       <0xF81F=> LCD_COLOR_GRAY
